...
//iterate through each block and ensure each hash aligns - check previous block property is same as hash on previous block
let validChain = true;

for(var i= 1; i < blockchain.length; i++){
  const currentBlock = blockchain[i]
  const prevBlock = blockchain[i - 1];
  //in order of hashing each block to check it begins with 0000
